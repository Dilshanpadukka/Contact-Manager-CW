	...
	public AddContactForm(){
		...
		txtSalary.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				...
				if(!isValidSalary){
					int option=JOptionPane.showConfirmDialog(null,"Invalid Salary... Do you want to input salary again ?","Confirm",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
					if(option==JOptionPane.YES_OPTION){
						txtSalary.setText("");
		...
		txtBirthday.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				...
				if(!isValidBirthday){
					int option=JOptionPane.showConfirmDialog(null,"Invalid BirthDay... Do you want to input birthday again ?","Confirm",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
					if(option==JOptionPane.YES_OPTION){
						txtBirthday.setText("");
