...
class HomePage extends JFrame{
    ...
    public HomePage(){
        ...
        // ImageIcon mainImage = new image("HomeImage.jpg");
        // ImageIcon scaledImage = mainImage.getImage().getScaledInstance(400, 400, Image.SCALE_SMOOTH);
        // ImageIcon resizedImageIcon = new ImageIcon(scaledImage);
        // mainImage.setBounds(10,50,400,400);
		// mainImage.setHorizontalAlignment(SwingConstants.CENTER);
		// westPanel.add("Center",mainImage);
